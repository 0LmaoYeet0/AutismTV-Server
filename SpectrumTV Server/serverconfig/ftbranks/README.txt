...
Last README file update: Fri Feb 28 13:33:07 PST 2025
...
command.bossbar.get.target
command.bossbar.get.target.get
command.bossbar.get.target.players
command.bossbar.get.target.visible
...
command.bossbar.set.target
command.bossbar.set.target.color
command.bossbar.set.target.color.blue
command.bossbar.set.target.color.green
command.bossbar.set.target.color.pink
command.bossbar.set.target.color.purple
command.bossbar.set.target.color.red
command.bossbar.set.target.color.yellow
command.bossbar.set.target.darken_sky
command.bossbar.set.target.darken_sky.darken_sky
command.bossbar.set.target.range
command.bossbar.set.target.range.range
command.bossbar.set.target.style
command.bossbar.set.target.style.notched_10
command.bossbar.set.target.style.notched_12
command.bossbar.set.target.style.notched_20
command.bossbar.set.target.style.notched_6
command.bossbar.set.target.style.progress
command.bossbar.set.target.thicken_fog
command.bossbar.set.target.thicken_fog.thicken_fog
command.bossbar.set.target.visible
command.bossbar.set.target.visible.visible
command.bwg
command.bwg.reload
